...
Future<void> initApp() => RustLib.instance.api.vibeAppInitApp();

/// You can also customize the bindings by #[uniffi::export]
/// Reference: https://mozilla.github.io/uniffi-rs/latest/proc_macro/index.html
Future<String> moproHelloWorld() =>
    RustLib.instance.api.vibeAppMoproHelloWorld();

Future<String> moproWasmHelloWorld() =>
    RustLib.instance.api.vibeAppMoproWasmHelloWorld();
...
}) => RustLib.instance.api.vibeAppGenerateCircomProof(
  zkeyPath: zkeyPath,
...
Future<bool> verifyCircomProof({
  ...
  required ProofLib proofLib,
}) => RustLib.instance.api.vibeAppVerifyCircomProof(
  zkeyPath: zkeyPath,
...
}) => RustLib.instance.api.vibeAppGenerateHalo2Proof(
  srsPath: srsPath,
  pkPath: pkPath,
  circuitInputs: circuitInputs,
);
...
}) => RustLib.instance.api.vibeAppVerifyHalo2Proof(
  srsPath: srsPath,
  vkPath: vkPath,
  proof: proof,
...
}) => RustLib.instance.api.vibeAppGenerateNoirProof(
...
Future<bool> verifyNoirProof({
  ...
  required List<int> vk,
  required bool lowMemoryMode,
}) => RustLib.instance.api.vibeAppVerifyNoirProof(
  circuitPath: circuitPath,
  proof: proof,
  onChain: onChain,
  vk: vk,
...
Future<Uint8List> getNoirVerificationKey({
  ...
  required bool onChain,
  required bool lowMemoryMode,
}) => RustLib.instance.api.vibeAppGetNoirVerificationKey(
  circuitPath: circuitPath,
  srsPath: srsPath,
  onChain: onChain,
  lowMemoryMode: lowMemoryMode,
...
class CircomProof {
  ...
  static Future<CircomProof> default_() =>
      RustLib.instance.api.vibeAppCircomProofDefault();
...
class G1 {
  ...
  static Future<G1> default_() => RustLib.instance.api.vibeAppG1Default();
...
class G2 {
  ...
  static Future<G2> default_() => RustLib.instance.api.vibeAppG2Default();
...
class Halo2ProofResult {
  ...
  static Future<Halo2ProofResult> default_() =>
      RustLib.instance.api.vibeAppHalo2ProofResultDefault();
...
enum ProofLib {
  ...
  static Future<ProofLib> default_() =>
      RustLib.instance.api.vibeAppProofLibDefault();
}
