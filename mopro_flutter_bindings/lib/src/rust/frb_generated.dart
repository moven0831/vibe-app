...
import 'third_party/vibe_app.dart';
...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -2092310466;
...
abstract class RustLibApi extends BaseApi {
  Future<CircomProof> vibeAppCircomProofDefault();

  Future<G1> vibeAppG1Default();

  Future<G2> vibeAppG2Default();

  Future<CircomProofResult> vibeAppGenerateCircomProof({
    required String zkeyPath,
    required String circuitInputs,
    required ProofLib proofLib,
  });

  Future<Halo2ProofResult> vibeAppGenerateHalo2Proof({
    required String srsPath,
    required String pkPath,
    required Map<String, List<String>> circuitInputs,
  });

  Future<Uint8List> vibeAppGenerateNoirProof({
  ...
  Future<Uint8List> vibeAppGetNoirVerificationKey({
    required String circuitPath,
    String? srsPath,
    required bool onChain,
    required bool lowMemoryMode,
  ...
  Future<Halo2ProofResult> vibeAppHalo2ProofResultDefault();

  Future<void> vibeAppInitApp();

  Future<String> vibeAppMoproHelloWorld();

  Future<String> vibeAppMoproWasmHelloWorld();

  Future<ProofLib> vibeAppProofLibDefault();

  Future<bool> vibeAppVerifyCircomProof({
    required String zkeyPath,
    required CircomProofResult proofResult,
    required ProofLib proofLib,
  });

  Future<bool> vibeAppVerifyHalo2Proof({
    required String srsPath,
  ...
  Future<bool> vibeAppVerifyNoirProof({
    required String circuitPath,
    required List<int> proof,
    required bool onChain,
    required List<int> vk,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<CircomProof> vibeAppCircomProofDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppCircomProofDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kVibeAppCircomProofDefaultConstMeta =>
  ...
  Future<G1> vibeAppG1Default() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppG1DefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kVibeAppG1DefaultConstMeta =>
  ...
  Future<G2> vibeAppG2Default() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppG2DefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kVibeAppG2DefaultConstMeta =>
  ...
  Future<CircomProofResult> vibeAppGenerateCircomProof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppGenerateCircomProofConstMeta,
  ...
  TaskConstMeta get kVibeAppGenerateCircomProofConstMeta => const TaskConstMeta(
  ...
  Future<Halo2ProofResult> vibeAppGenerateHalo2Proof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppGenerateHalo2ProofConstMeta,
  ...
  TaskConstMeta get kVibeAppGenerateHalo2ProofConstMeta => const TaskConstMeta(
  ...
  Future<Uint8List> vibeAppGenerateNoirProof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppGenerateNoirProofConstMeta,
  ...
  TaskConstMeta get kVibeAppGenerateNoirProofConstMeta => const TaskConstMeta(
  ...
  Future<Uint8List> vibeAppGetNoirVerificationKey({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppGetNoirVerificationKeyConstMeta,
  ...
  TaskConstMeta get kVibeAppGetNoirVerificationKeyConstMeta =>
      const TaskConstMeta(
  ...
  Future<Halo2ProofResult> vibeAppHalo2ProofResultDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppHalo2ProofResultDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kVibeAppHalo2ProofResultDefaultConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> vibeAppInitApp() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppInitAppConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kVibeAppInitAppConstMeta =>
  ...
  Future<String> vibeAppMoproHelloWorld() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppMoproHelloWorldConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kVibeAppMoproHelloWorldConstMeta =>
  ...
  Future<String> vibeAppMoproWasmHelloWorld() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppMoproWasmHelloWorldConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kVibeAppMoproWasmHelloWorldConstMeta =>
  ...
  Future<ProofLib> vibeAppProofLibDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppProofLibDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kVibeAppProofLibDefaultConstMeta =>
  ...
  Future<bool> vibeAppVerifyCircomProof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppVerifyCircomProofConstMeta,
  ...
  TaskConstMeta get kVibeAppVerifyCircomProofConstMeta => const TaskConstMeta(
  ...
  Future<bool> vibeAppVerifyHalo2Proof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppVerifyHalo2ProofConstMeta,
  ...
  TaskConstMeta get kVibeAppVerifyHalo2ProofConstMeta => const TaskConstMeta(
  ...
  Future<bool> vibeAppVerifyNoirProof({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kVibeAppVerifyNoirProofConstMeta,
  ...
  TaskConstMeta get kVibeAppVerifyNoirProofConstMeta => const TaskConstMeta(
